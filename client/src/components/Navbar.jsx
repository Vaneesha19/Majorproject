...
import ArtistConnectLogo from "./FiverrLogo";
...
// import React, { useEffect, useState } from "react";
// import ArtistConnectLogo from "./FiverrLogo"; // ✅ Updated logo import
// import Link from "next/link";
// import { IoSearchOutline } from "react-icons/io5";
// import { useRouter } from "next/router";
// import Image from "next/image";
...
//   const handleOrdersNavigate = () => {
//     if (isSeller) router.push("/artist-dashboard/orders");
//     router.push("/buyer/orders");
//   };
...
//           let projectedUserInfo = { ...user };
//           if (user.image) {
//             projectedUserInfo = { ...projectedUserInfo, imageName: HOST + "/" + user.image };
//           }
//           delete projectedUserInfo.image;
...
//           <div >
//             <Link href="/">
//               <ArtistConnectLogo fillColor={!navFixed && !userInfo ? "#ffffff" : "#404145"} />
//             </Link>
//           </div>
//           <div className={`flex ${navFixed || userInfo ? "opacity-100" : "opacity-0"}`}>
//             <input
//               type="text"
//               placeholder="What art service are you looking for today?"
//               className="w-[30rem] py-2.5 px-4 border"
//               value={searchData}
//               onChange={(e) => setSearchData(e.target.value)}
//             />
...
//                       onClick={handler}
//                       className={`border text-md font-semibold py-1 px-3 rounded-sm ${
//                         navFixed ? "border-[#FF5733] text-[#FF5733]" : "border-white text-white"
//                       } hover:bg-[#FF5733] hover:text-white hover:border-[#FF5733] transition-all duration-500`}
//                     >
//                       {linkName}
//                     </button>
//                   )}
...
//             <ul className="flex gap-10 items-center">
//               {isSeller && (
//                 <li className="cursor-pointer text-[#FF5733] font-medium" onClick={() => router.push("/artist-dashboard/gigs/create")}>
//                   Create Listing
//                 </li>
//               )}
//               <li className="cursor-pointer text-[#FF5733] font-medium" onClick={handleOrdersNavigate}>
//                 Orders
//               </li>
//               <li className="cursor-pointer font-medium" onClick={handleModeSwitch}>
//                 {isSeller ? "Switch To Buyer" : "Switch To Artist"}
//               </li>
//             </ul>
//           )}
//           {isContextMenuVisible && <ContextMenu data={ContextMenuData} />}
