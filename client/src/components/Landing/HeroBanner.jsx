        ...
        <div className="text-white flex gap-4">
          ...
          <ul className="flex gap-5">
            <li
              ...
              onClick={() => router.push("/search?category=Photography")}
            >
              Photography
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?category=event management")}
            >
              Event Management
            </li>
            <li
              className="text-sm py-1 px-3 border rounded-full hover:bg-white hover:text-black transition-all duration-300	cursor-pointer"
              onClick={() => router.push("/search?category=art workshops")}
            >
              Art Workshops
            </li>
